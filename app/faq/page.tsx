    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Meilleurs scores : Niche/luxe (DTC) : 78. B2B industriel : 72. Services digitaux : 71. Pires scores : Fashion Amazon-dépendant : 31. Electroni

que marketplace : 35. Dropshipping : 26. Raison : fashion/électronique = forte concurrence prix + domination Amazon. B2B/niche = moins dépendant marketplaces, relations directes."
        },
        {
